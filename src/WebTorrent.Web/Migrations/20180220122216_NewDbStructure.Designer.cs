...
namespace WebTorrent.Web.Migrations
{
    ...
    [Migration("20180220122216_NewDbStructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("WebTorrent.Data.Models.ApplicationRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebTorrent.Data.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.Order", b =>
                {
                    b.HasOne("WebTorrent.Data.Models.ApplicationUser", "Cashier")
                        .WithMany("Orders")
                        .HasForeignKey("CashierId");

                    b.HasOne("WebTorrent.Data.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.OrderDetail", b =>
                {
                    b.HasOne("WebTorrent.Data.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebTorrent.Data.Models.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("WebTorrent.Data.Models.Product", b =>
                {
                    b.HasOne("WebTorrent.Data.Models.Product", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("WebTorrent.Data.Models.ProductCategory", "ProductCategory")
                        .WithMany("Products")
